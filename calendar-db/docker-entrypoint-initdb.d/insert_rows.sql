...
VALUES
(1, 1, 'Quarterly Business Review', '2023-12-01 09:00:00+00', '2023-12-01 11:00:00+00', FALSE, 'Discuss quarterly performance and targets.', 'Conference Room A'),
(1, 2, 'Project Kickoff Meeting', '2023-12-02 13:00:00+00', '2023-12-02 14:30:00+00', FALSE, 'Kickoff meeting for the new project.', 'Conference Room B'),
(2, 3, 'Team Building Activity', '2023-12-05 10:00:00+00', NULL, TRUE, 'Outdoor activities for team bonding.', 'Central Park'),
(2, 4, 'Webinar: Industry Trends', '2023-12-07 15:00:00+00', '2023-12-07 16:30:00+00', FALSE, 'Webinar on the latest trends in the industry.', 'Online');
